(function () {
    ...
    let SZData = [
        ...
        [{ name: "深圳" }, { name: "台北", value: 100 }],
        [{ name: "深圳" }, { name: "重庆", value: 100 }],
        [{ name: "深圳" }, { name: "沈阳", value: 100 }],
        [{ name: "深圳" }, { name: "哈尔滨", value: 100 }],
        [{ name: "深圳" }, { name: "成都", value: 100 }],
    ]
    ...
    let SHData = [
        ...
        [{ name: "上海" }, { name: "拉萨", value: 100 }],
        [{ name: "上海" }, { name: "广州", value: 100 }],
        [{ name: "上海" }, { name: "南昌", value: 100 }],
        [{ name: "上海" }, { name: "武汉", value: 100 }],
        [{ name: "上海" }, { name: "杭州", value: 100 }],
        [{ name: "上海" }, { name: "成都", value: 100 }],
    ...
    let WLMQData = [
        ...
        [{ name: "乌鲁木齐" }, { name: "昆明", value: 100 }],
        [{ name: "乌鲁木齐" }, { name: "上海", value: 100 }],
        [{ name: "乌鲁木齐" }, { name: "广州", value: 100 }],
        [{ name: "乌鲁木齐" }, { name: "武汉", value: 100 }],
        [{ name: "乌鲁木齐" }, { name: "深圳", value: 100 }],
        [{ name: "乌鲁木齐" }, { name: "杭州", value: 100 }],
